...
之前写过在python中使用weibo API的方法，见[这里](/2013-03-22-通过python-sdk使用weibo-api/)，但是因为weibo API有频率限制，不够目前需求使用，所以通过爬虫模拟登录weibo进行直接抓取还是很有必要的，第一步要做的事情就是模拟登录过程。
...
代码如下，注释比较少，主要是\_\_login()函数内的过程，需要安装rsa包，easy\_install即可 
