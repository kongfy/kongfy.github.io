...
<figure style="text-align: center;">
  <img src="/assets/images/data-protection.jpg" alt="Data protection" />
...
锁结构的定义分为两部分，第一部分为实际使用的结构，定义在<linux/spinlock\_types.h>中，另一部分为体系结构相关的具体实现，定义在<asm/spinlock\_types.h>中，来个例子：
